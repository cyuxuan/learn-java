...
public class ScheduleUtils {
     ...
     * 创建定时任务
     */
    public static void createScheduleJob(Scheduler scheduler, ScheduleJobTask scheduleJob) {
        try {
            //构建job信息
            ...
            //放入参数，运行时的方法可以获取
            jobDetail.getJobDataMap().put(ScheduleJobTask.JOB_PARAM_KEY, scheduleJob);
     ...
     * 更新定时任务
     */
    public static void updateScheduleJob(Scheduler scheduler, ScheduleJobTask scheduleJob) {
        try {
            ...
            //参数
            trigger.getJobDataMap().put(ScheduleJobTask.JOB_PARAM_KEY, scheduleJob);
     ...
     * 立即执行任务
     */
    public static void run(Scheduler scheduler, ScheduleJobTask scheduleJob) {
        try {
            //参数
            JobDataMap dataMap = new JobDataMap();
            dataMap.put(ScheduleJobTask.JOB_PARAM_KEY, scheduleJob);
