...
package club.beenest.blog.support.common.controller.job;
...
import club.beenest.blog.support.util.ValidatorUtils;
...
public class ScheduleJobController {
    ...
    public Result jobs(@RequestParam(defaultValue = "1") Integer pageNum,
        ...
        PageInfo<ScheduleJobTask> pageInfo = new PageInfo<>(scheduleJobService.getJobList());
    ...
    @PostMapping("/job")
    public Result saveJob(@RequestBody ScheduleJobTask scheduleJob) {
    ...
    @PutMapping("/job")
    public Result updateJob(@RequestBody ScheduleJobTask scheduleJob) {
        scheduleJob.setStatus(false);
        ValidatorUtils.validateEntity(scheduleJob);
