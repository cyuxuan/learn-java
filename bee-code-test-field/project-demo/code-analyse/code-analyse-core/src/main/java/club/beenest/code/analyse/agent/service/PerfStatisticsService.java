...
package club.beenest.code.analyse.agent.service;

import club.beenest.code.analyse.agent.sourceobject.MethodRunTimeDescription;
import club.beenest.code.analyse.agent.result.ResultHandler;
import club.beenest.code.analyse.agent.result.Result;
...
public class PerfStatisticsService {
     ...
     * 基本类型会失败, 重载
     *
     * @param returnValues 函数的返回参数
     */
    public static void popMethodCallInfoOnThread(char returnValues) {
        popMethodCallInfoOnThread((Object) returnValues);
    }
