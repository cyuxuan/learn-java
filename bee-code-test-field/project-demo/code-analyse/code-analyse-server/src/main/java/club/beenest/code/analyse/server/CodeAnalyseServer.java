...
package club.beenest.code.analyse.server;
...
public class CodeAnalyseServer {
    /**
     * 服务器端启动的方法
     *
    ...
    private void readOperator(Selector selector, SelectionKey selectionKey) throws IOException {
        ...
        if (message.length() > 0) {
            ...
            reviceMessage(message, selector, socketChannel);
        }
    }
     ...
     * @throws IOException IO异常
     */
    private void reviceMessage(String message, Selector selector, SocketChannel socketChannel) throws IOException {
        //1 获取所有已经接入channel
